...
var CategoryResolver = {
    ...
    Mutation: {
        addCategory: auth_1.authenticated(auth_1.authorized(user_1.UserRole.admin, function (_, _a) {
            var input = _a.input;
            return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            category = category_1.Category.build({ name: input.name.toLowerCase() });
