    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                url = utils_1.getMessageServerUrl(req);
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
...
router.post("/*", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, axios_1.default.post(url, JSON.parse(JSON.stringify(req.body)), {
                        headers: {
            ...
            case 3:
                err_2 = _a.sent();
                console.log("err is occured ", err_2);
...
router.put("/*", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, axios_1.default.put(url, req.body, {
                        headers: {
                            authorization: req.headers.authorization,
                        },
                    })];
...
router.patch("/*", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, axios_1.default.patch(url, req.body, {
                        headers: {
                            authorization: req.headers.authorization,
                        },
                    })];
